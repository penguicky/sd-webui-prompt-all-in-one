        ...
        <div class="format-list" @click.stop>
          ...
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:autoRemoveLastComma', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_remove_last_comma')"
            ></div>
          </div>
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:autoKeepWeightZero', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_keep_weight_zero')"
            ></div>
          </div>
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:autoBreakBeforeWrap', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_break_before_wrap')"
            ></div>
          </div>
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:autoBreakAfterWrap', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_break_after_wrap')"
            ></div>
          </div>
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:autoRemoveLoraBeforeComma', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_remove_lora_before_comma')"
            ></div>
          </div>
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:autoRemoveLoraAfterComma', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_remove_lora_after_comma')"
            ></div>
          </div>
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:useNovelAiWeightSymbol', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_use_novel_ai_weight_symbol')"
            ></div>
          </div>
          <div class="format-item">
            <input
              ...
              @change="
                $emit('update:autoRemoveBeforeLineComma', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_remove_before_line_comma')"
            ></div>
          </div>
          <div class="format-item">
            <input
              class="format-checkbox"
              type="checkbox"
              :checked="autoFormatCategorySpacing"
              @change="
                $emit('update:autoFormatCategorySpacing', $event.target.checked)
              "
            />
            <div
              class="format-desc"
              v-html="getLang('is_format_category_spacing')"
            ></div>
          </div>
          <div class="format-item">
            <input
              class="format-checkbox"
              type="checkbox"
              :checked="autoRemoveCategoryTrailingComma"
              @change="
                $emit(
            ...
            <div
              class="format-desc"
              v-html="getLang('is_remove_category_trailing_comma')"
            ></div>
          </div>
        </div>
      </div>
